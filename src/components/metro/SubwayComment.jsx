...
export function SubwayComment({ query , userip, token}) {
    ...
    const getCommentList = async() => {
        try {
            const getCommentListResponse = await axios.get(`http://localhost:5000/search/comment`);
    ...
    const createComment = async(e) => {
        ...
        try {
            const createCommentResponse = await axios.post(`http://localhost:5000/search/comment`, {
                query:query, 
                userid:userid, 
                userip : userip,
    ...
    const patchLikes = async (commentid) => {
        ...
        try {
            const patchLikesResponse = await axios.patch(`http://localhost:5000/search/comment`, { 
                commentid :  commentid,
                userid : userid,
            });
