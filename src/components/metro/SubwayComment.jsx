...
export function SubwayComment({ query , userip, token}) {
    ...
    const getCommentList = async() => {
        try {
            const getCommentListResponse = await axios.get(`https://port-0-searchmetro-backend-m5kj7lff67bc616e.sel4.cloudtype.app/comment`);
    ...
    const createComment = async(e) => {
        ...
        try {
            const createCommentResponse = await axios.post(`https://port-0-searchmetro-backend-m5kj7lff67bc616e.sel4.cloudtype.app/comment`, {
                query:query, 
                userid:userid, 
                userip : userip,
    ...
    const patchLikes = async (commentid) => {
        ...
        try {
            const patchLikesResponse = await axios.patch(`https://port-0-searchmetro-backend-m5kj7lff67bc616e.sel4.cloudtype.app/comment`, { 
                commentid :  commentid,
                userid : userid,
            });
