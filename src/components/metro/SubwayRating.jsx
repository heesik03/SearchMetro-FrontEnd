...
export function SubwayRating({query , token}) {
    ...
    const getRatingData = async() => {
      try {
        const getRatingDataResponse = await axios.get(`${process.env.REACT_APP_BACKEND_LINK}/search/rating?query=${query}`);
    ...
    const addRating = async() => {
      ...
      try {
        const addRatingResponse = await axios.post(`${process.env.REACT_APP_BACKEND_LINK}/search/rating`, {
          query : query,
          score : starScore,
          userid : userid,
        })
